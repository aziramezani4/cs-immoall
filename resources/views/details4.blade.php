              ...
              >
                <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                  <div class="col-">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">FREE (LIMITED)</h4>
                      </div>
                      <div class="card-body">
                        <h1 class="card-title pricing-card-title">
                          Free(welcome discount - advertise now for free - only
                  ...
                  <div class="col-">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">STARTUP</h4>
                      </div>
                      <div class="card-body">
                        <h1 class="card-title pricing-card-title">
                          40 CHF<small class="text-muted fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4"></ul>
                        <button
                          type="submit"
                  ...
                  <div class="col-">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      ...
                      <div class="card-body">
                        <h1 class="card-title pricing-card-title">
                          60 CHF<small class="text-muted fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4"></ul>
                        <button
                          type="submit"
                  ...
                  <div class="col-">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      ...
                      <div class="card-body">
                        <h1 class="card-title pricing-card-title">
                          80 CHF<small class="text-muted fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4"></ul>
                        <button
                          type="submit"
                  ...
                  <div class="col-">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      ...
                      <div class="card-body">
                        <h1 class="card-title pricing-card-title">
                          100 CHF<small class="text-muted fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4"></ul>
                        <button
                          type="submit"
